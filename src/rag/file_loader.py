...
# Tìm kiếm tệp theo mẫu đường dẫn.
import glob
# Hiển thị thanh tiến trình khi thực hiện các tác vụ mất thời gian.
from tqdm import tqdm
# Tận dụng nhiều CPU để thực hiện các tác vụ song song, tăng tốc độ xử lý.
...
class Loader:
    def __init__(self,
                 ...
                 split_kwargs: dict = {"chunk_size": 1000,
                                        "chunk_overlap": 200}
                 ) -> None:
